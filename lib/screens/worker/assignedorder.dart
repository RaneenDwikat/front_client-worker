...
class assignedorderPage extends StatefulWidget {
  var name;
  assignedorderPage(this.name);
  @override
  _assignedorderPageState createState() => _assignedorderPageState(name);
}

class _assignedorderPageState extends State<assignedorderPage> {
  var name, selectedRoom;
  var _id;
  _assignedorderPageState(this.name);
    ...
    return Scaffold(
        ...
        body: NestedScrollView(
            ...
            body: FutureBuilder<List>(
              future: service.getworkerorder(name),
